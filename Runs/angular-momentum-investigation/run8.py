#@+leo-ver=4-thin
#@+node:gcross.20090826111206.1513:@thin run8.py
#@<< Imports >>
#@+node:gcross.20090826111206.1514:<< Imports >>
import gc
...
#@+node:gcross.20090826111206.1515:<< System Configuration >>
configuration = {
    # System parameters
...
#@+node:gcross.20090826111206.1516:<< Histogram Configuration >>
...
for number_of_particles in [6]:
    for frame_angular_velocity in [0.4]:
        for number_of_rotating_particles in xrange(number_of_particles+1):
            ...
            #@+node:gcross.20090826111206.1517:<< Run simulation for given parameters >>
            ...
            #@+node:gcross.20090826111206.1518:<< Initialize observables >>
            for slice_name, slice_number in [("center",system.center_slice_number)]:
                ...
                for observable in [
                        AngularVelocitySquaredAndRecipricalRadiusSquaredHistogram(
                            slice_number,
                            1,
                            15,
                            200,
                            density_slice_subdirectory + "/angular-velocity-squared-and-reciprical-radius-squared"
                        ),
                    ]:
