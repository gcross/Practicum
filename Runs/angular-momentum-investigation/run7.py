#@+leo-ver=4-thin
#@+node:gcross.20090826111206.1493:@thin run7.py
#@<< Imports >>
#@+node:gcross.20090826111206.1494:<< Imports >>
import gc
...
#@+node:gcross.20090826111206.1495:<< System Configuration >>
configuration = {
    # System parameters
...
#@+node:gcross.20090826111206.1496:<< Histogram Configuration >>
...
for number_of_particles in [6]:
    for frame_angular_velocity in [0.4]:
        for number_of_rotating_particles in xrange(number_of_particles+1):
            ...
            #@+node:gcross.20090826111206.1497:<< Run simulation for given parameters >>
            ...
            #@+node:gcross.20090826111206.1498:<< Initialize observables >>
