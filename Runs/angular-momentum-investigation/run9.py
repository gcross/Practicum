#@+leo-ver=4-thin
#@+node:gcross.20090826111206.1531:@thin run9.py
#@<< Imports >>
#@+node:gcross.20090826111206.1532:<< Imports >>
import gc
...
#@+node:gcross.20090826111206.1533:<< System Configuration >>
configuration = {
    # System parameters
...
#@+node:gcross.20090826111206.1534:<< Histogram Configuration >>
...
for number_of_particles in [6]:
    for frame_angular_velocity in [0.4]:
        for number_of_rotating_particles in xrange(number_of_particles+1):
            ...
            #@+node:gcross.20090826111206.1535:<< Run simulation for given parameters >>
            ...
            #@+node:gcross.20090826111206.1536:<< Initialize observables >>
            for slice_name, slice_number in [("center",system.center_slice_number)]:
                ...
                for observable in [
                        RotationQuadraticTermHistogram(
                            slice_number,
                            0,15,
                            200,
                            density_slice_subdirectory + "/rotation-quadratic-term-histogram"
                        ),
                        AverageRotationQuadraticTermEstimate(
                            slice_number,
                            "{my_directory}/{slice_name}/average-rotation-quadratic-term".format(**vars()),
