#@+leo-ver=4-thin
#@+node:gcross.20090825142352.1434:@thin run3.py
#@<< Imports >>
#@+node:gcross.20090825142352.1435:<< Imports >>
import gc
...
#@+node:gcross.20090825142352.1436:<< System Configuration >>
configuration = {
    # System parameters
...
#@+node:gcross.20090825142352.1437:<< Histogram Configuration >>
...
for number_of_particles in [6]:
    for frame_angular_velocity in [0.4]:
        for number_of_rotating_particles in xrange(number_of_particles+1):
            ...
            #@+node:gcross.20090825142352.1438:<< Run simulation for given parameters >>
            ...
            #@+node:gcross.20090825142352.1439:<< Initialize observables >>
