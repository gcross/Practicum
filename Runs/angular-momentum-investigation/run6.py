#@+leo-ver=4-thin
#@+node:gcross.20090826111206.1473:@thin run6.py
#@<< Imports >>
#@+node:gcross.20090826111206.1474:<< Imports >>
import gc
...
#@+node:gcross.20090826111206.1475:<< System Configuration >>
configuration = {
    # System parameters
...
#@+node:gcross.20090826111206.1476:<< Histogram Configuration >>
...
for number_of_particles in [6]:
    for frame_angular_velocity in [0.4]:
        for number_of_rotating_particles in xrange(number_of_particles+1):
            ...
            #@+node:gcross.20090826111206.1477:<< Run simulation for given parameters >>
            ...
            #@+node:gcross.20090826111206.1478:<< Initialize observables >>
            for slice_name, slice_number in [("center",system.center_slice_number)]:
                ...
                for observable in [
                        ...
                        AngularVelocityAndRadiusHistogram(
                            slice_number,
                            1,
                            2.5,
                            50,
                            density_slice_subdirectory + "/angular-velocity-and-radius"
                        ),
                    ]:
