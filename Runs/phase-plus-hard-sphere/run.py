...
class RotationEffectivePotential(Physics):
    ...
    def accumulate_potential(self,x,xij2,U,gradU2):
        gradient_phase = vpif.angular_momentum.compute_gradient_ho_phase_old(
            x,
...
for frame_angular_velocity in [1]:
    for hard_sphere_radius in [0.2]:
        for number_of_particles in [4]:
            for number_of_rotating_particles in xrange(6*number_of_particles+1):
